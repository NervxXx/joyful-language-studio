  ...
  return (
    <motion.div className="p-5 md:p-8 lg:p-12 max-w-4xl mx-auto space-y-10" variants={container} initial="hidden" animate="show">
      ...
      <motion.div variants={item} className="space-y-1.5">
        ...
        <p className="text-muted-foreground text-sm md:text-base">Готов продолжить обучение?</p>
      </motion.div>
      ...
      <motion.div variants={item}>
        <Card className="p-5 md:p-6 bg-card shadow-sm rounded-xl">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs text-muted-foreground font-medium">13 / 20 min</span>
          </div>
      ...
      <motion.div variants={item}>
        <Card
          ...
          className="card-hover cursor-pointer p-5 md:p-6 bg-card shadow-sm rounded-xl flex items-center gap-5"
        >
          <div className="w-12 h-12 rounded-xl bg-primary/8 flex items-center justify-center shrink-0">
            <span className="text-xl">💬</span>
          </div>
          <div className="flex-1 min-w-0">
            <h2 className="font-bold text-foreground font-heading">Continue conversation</h2>
            <p className="text-sm text-muted-foreground mt-1">Chef role · A2 level · 4 min left</p>
          </div>
      ...
      <motion.div variants={item} className="space-y-4">
        <h2 className="section-heading">Modes</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <Card
              ...
              className="card-hover cursor-pointer p-5 md:p-6 bg-card shadow-sm rounded-xl group"
            >
