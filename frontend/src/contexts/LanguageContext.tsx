...
const t = {
  ...
  "chat.coachNeutral": { ru: "Нейтральный", en: "Neutral" },
  "chat.coachCustom": { ru: "Свой характер", en: "Custom" },
  "chat.coachCustomPlaceholder": { ru: "Опишите характер коуча...", en: "Describe the coach personality..." },
